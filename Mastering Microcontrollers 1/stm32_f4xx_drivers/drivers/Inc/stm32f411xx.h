...
#define SPI3_BASEADDR			(ABP1PERIPH_BASEADDR+0x3C00)

#define USART2_BASEADDR			(ABP1PERIPH_BASEADDR+0x4400)
#define USART3_BASEADDR			(ABP1PERIPH_BASEADDR+0x4800)
#define UART4_BASEADDR			(ABP1PERIPH_BASEADDR+0x4С00)
#define UART5_BASEADDR			(ABP1PERIPH_BASEADDR+0x5000)

/*
 * Base addresses of peripherals wich are hanging on APB2 bus
 */
